...
//               <span className="ml-2 text-2xl font-bold text-gray-900">StatusGuard</span>
//             </Link>
//             <h2 className="text-3xl font-bold tracking-tight">Create your account</h2>
//             <p className="mt-2 text-sm text-gray-600">Start monitoring your websites in minutes</p>
//           </div>
...
//           <div>
//             <h3 className="text-3xl font-bold mb-4">Monitor with Confidence</h3>
//             <p className="text-blue-100 text-lg">
//               Join thousands of businesses that trust StatusGuard to keep their websites online 24/7
//             </p>
//           </div>
...
//                 <p className="text-blue-100 text-sm">Get instant alerts when your website goes down</p>
//               </div>
//             </div>
...
//               <div>
//                 <h4 className="font-semibold">Lightning Fast Detection</h4>
//                 <p className="text-blue-100 text-sm">Detect issues in under 30 seconds from global locations</p>
//               </div>
//             </div>
...
//                 <p className="text-blue-100 text-sm">Monitor from 15+ locations worldwide for complete coverage</p>
//               </div>
//             </div>
//           </div>
